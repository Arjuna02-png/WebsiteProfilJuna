...
document.addEventListener('DOMContentLoaded', () => {
    const animateElements = document.querySelectorAll('.skill-card, .project-card, .stat-item, .about-text, .contact-content');
...
//         typingEffect(roleElement, originalText, 100);
//     }
// });
...
// Console message
console.log('%c👋 Halo! Selamat datang di portfolio saya!', 'color: #6366f1; font-size: 20px; font-weight: bold;');
console.log('%cWebsite ini dibuat dengan HTML, CSS, dan JavaScript murni.', 'color: #6b7280; font-size: 14px;');
